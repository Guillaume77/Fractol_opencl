...
void	ft_draw_rec(void *img, int clr, void *rec);

void *init_data_rect(int x, int y, int width, int height);

void	draw_fill_rec(void *img, int clr, void *rec, double alpha);
